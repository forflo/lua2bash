describe(
    ...
    function()
        ...
        it("tests a simple parameter expansion use cases #PE",
           function()
               assert.are.equal(b.parenthesesE("foo")(), [[${foo}]])
               assert.are.equal(b.parenthesesE(b.string("foo"))(), [[${foo}]])
        end)

        it("tests another simple parameter expansion use case #PE",
           function()
               local str = b.parenthesesE(b.paramExpansion("foo"))()
