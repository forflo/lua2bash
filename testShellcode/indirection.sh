...
# print(a[1][2]) 
eval eval TL${E2}_11=\(\${!V${E2}G_a} \\\${\${V${E2}G_a}[1]}\) 
eval TL${E2}_12=\(1 NUM\) 
eval eval TL${E2}_13=\(\\\${\${TL${E2}_11}\${TL${E2}_12}} \\\${\${TL${E2}_11}\${TL${E2}_12}[1]}\) 
eval TL${E2}_14=\(2 NUM\) 
eval eval TL${E2}_15=\(\\\${\${TL${E2}_13}\${TL${E2}_14}} \\\${\${TL${E2}_13}\${TL${E2}_14}[1]}\) 
eval echo \${TL${E2}_15} 
# a[1] = {42, 44} 
# {42, 44} 
...
eval eval TL${E2}_20=\(\${!V${E2}G_a} \\\${\${V${E2}G_a}[1]}\) 
eval TL${E2}_21=\(1 NUM\) 
eval eval \${TL${E2}_20}\${TL${E2}_21}=\\\(\${TL${E2}_19} \${TL${E2}_19[1]}\\\) 
# print(a[1][2]) 
eval eval TL${E2}_22=\(\${!V${E2}G_a} \\\${\${V${E2}G_a}[1]}\) 
eval TL${E2}_23=\(1 NUM\) 
eval eval TL${E2}_24=\(\\\${\${TL${E2}_22}\${TL${E2}_23}} \\\${\${TL${E2}_22}\${TL${E2}_23}[1]}\) 
eval TL${E2}_25=\(2 NUM\) 
eval eval TL${E2}_26=\(\\\${\${TL${E2}_24}\${TL${E2}_25}} \\\${\${TL${E2}_24}\${TL${E2}_25}[1]}\) 
